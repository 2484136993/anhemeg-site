#!/usr/bin/env python3
"""Generate Chinese plastic surgery guide article HTML - 20260629"""
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>{title}</h1>
            <p>上海安禾美阁 · 国际患者指南 · 更新于 {date_str}</p>
        </div>
    </section>
        ...
        <div class="container">
            <article class="article-detail">
                ...
                <div class="disclaimer">
                    <h3>免责声明</h3>
                    <p>本文仅供参考，不构成医疗建议。整容手术为医疗美容项目，存在一定风险性，个体效果因人而异。请在充分了解手术信息后，与合格的医疗专业人员详细咨询，做出适合自身情况的治疗决策。</p>
                </div>
            </article>
        </div>
    </section>
...
zh_md = read_md('/app/data/所有对话/主对话/SEO优化/原创文章/20260629/plastic-surgery-shanghai-what-to-note-2026-zh.md')
fm_zh, zh_body = parse_frontmatter(zh_md)

zh_content = md_to_html(zh_body)
zh_html = ZH_TEMPLATE.format(
    title=fm_zh.get('title', '上海整容手术需要注意什么？国际患者必读指南2026'),
...
with open('news/plastic-surgery-shanghai-what-to-note.html', 'w', encoding='utf-8') as f:
    f.write(zh_html)
print(f"ZH article created: news/plastic-surgery-shanghai-what-to-note.html")
print("Done!")
