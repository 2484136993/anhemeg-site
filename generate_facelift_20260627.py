#!/usr/bin/env python3
"""Generate facelift cost articles HTML - 20260627"""
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>{title}</h1>
            <p>Anhe Meige · Facelift Surgery Guide · Updated {date_str}</p>
        </div>
    </section>
    ...
    <section class="contact-section">
        <div class="container">
            <h2>Ready to Explore Facelift Options in Shanghai?</h2>
...
<body>
    ...
    <section class="page-header">
        <div class="container">
            <h1>{title}</h1>
            <p>Anhe Meige · Hướng dẫn phẫu thuật căng da mặt · Cập nhật {date_str}</p>
        </div>
    </section>
    ...
    <section class="contact-section">
        <div class="container">
            <h2>Bạn đã sẵn sàng khám phá các lựa chọn căng da mặt tại Thượng Hải?</h2>
...
# Generate EN article
en_md = read_md('/app/data/所有对话/主对话/SEO优化/原创文章/20260627/facelift-surgery-cost-shanghai-2026-en.md')
fm_en, en_body = parse_frontmatter(en_md)

en_content = md_to_html(en_body)
en_html = EN_TEMPLATE.format(
    title=fm_en.get('title', 'Facelift Surgery Cost Guide 2026'),
    description=fm_en.get('description', ''),
    keywords=fm_en.get('keywords', ''),
    canonical=fm_en.get('canonical', 'https://anhemeg.top/en/facelift-surgery-cost-shanghai-2026/'),
    zh_url='https://anhemeg.top/news/facelift-surgery-cost-shanghai-2026/',
...
with open('en/news/facelift-surgery-cost-shanghai-2026.html', 'w', encoding='utf-8') as f:
    f.write(en_html)
print("EN article created: en/news/facelift-surgery-cost-shanghai-2026.html")

# Generate VI article
vi_md = read_md('/app/data/所有对话/主对话/SEO优化/原创文章/20260627/gia-cang-da-mat-thuong-hai-2026-vi.md')
fm_vi, vi_body = parse_frontmatter(vi_md)

vi_content = md_to_html(vi_body)
vi_html = VI_TEMPLATE.format(
    title=fm_vi.get('title', 'Giá Căng Da Mặt Thượng Hải 2026'),
    description=fm_vi.get('description', ''),
    keywords=fm_vi.get('keywords', ''),
    canonical=fm_vi.get('canonical', 'https://anhemeg.top/vi/gia-cang-da-mat-thuong-hai-2026/'),
    zh_url='https://anhemeg.top/news/facelift-surgery-cost-shanghai-2026/',
...
with open('vi/news/gia-cang-da-mat-thuong-hai-2026.html', 'w', encoding='utf-8') as f:
    f.write(vi_html)
print("VI article created: vi/news/gia-cang-da-mat-thuong-hai-2026.html")
